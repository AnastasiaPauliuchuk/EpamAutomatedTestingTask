...
public class VerifyCombinationFlightCostTest extends BaseTest {
    ...
    @BeforeClass
    @Parameters({"outboundDeparture", "outboundArrival", "outboundDate", "inboundDeparture", "inboundArrival", "inboundDate", "dateFormat"})
    public void setUp(String outboundDeparture, String outboundArrival, String outboundDate,
                      String inboundDeparture, String inboundArrival, String inboundDate, String dateFormat) {
